...
export const metadata: Metadata = {
  title: 'Autocares del Río - Más de 50 años conectando Toledo con España y Portugal',
  ...
  keywords: 'autocares Toledo, autobuses Toledo, transporte bodas, excursiones Puy de Fou, IMSERSO, transporte escolar, alquiler autobuses Madrid',
  authors: [{ name: 'Autocares del Río' }],
  openGraph: {
    title: 'Autocares del Río - Más de 50 años de experiencia',
